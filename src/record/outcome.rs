...
pub enum RejectionReason {
    ...
    ResidualUrlDetected,
    AdKeywordRatioExceeded,
    SeoSpamScoreExceeded,
    NaturalnessScoreTooLow,
    DuplicateExact,
...
impl RejectionReason {
    pub fn as_key(&self) -> String {
        match self {
            ...
            RejectionReason::AdKeywordRatioExceeded => "ad_keyword_ratio_exceeded".to_string(),
            RejectionReason::SeoSpamScoreExceeded => "seo_spam_score_exceeded".to_string(),
            RejectionReason::NaturalnessScoreTooLow => "naturalness_score_too_low".to_string(),
